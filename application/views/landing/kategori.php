	...
	<div class="container">
		<div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
			<div class="col-md-8 ftco-animate text-center">
				...
				<h1 class="mb-3 bread">Koleksi Buku <?=$data_kategori['kategori'] ?></h1>
			</div>
		</div>
	</div>
</div>
					...
					<div class="card-body">
						<form>
							<div class="input-group mb-3">
								<input type="text" class="form-control" placeholder="Masukkan kata kunci.." aria-label="Recipient's username" aria-describedby="button-addon2">
					...
					<?php foreach ($buku as $bk): ?>
						<div class="col-lg-6 col-md-6 mb-4">
							<div class="card h-100 shadow-lg border-0">
								...
								<div class="card-body">
									<div class="text">
										<p class="category"><a href="<?=base_url('landing/kategori/').$bk['id'] ?>" class="btn btn-warning btn-sm"><?=$bk['kategori'] ?></a></p>
